  ...
  return (
   ...
   //  </div>
    <div className="h-screen flex overflow-hidden">
      {/* Sidebar */}
      <div
        className={`fixed md:relative z-50 top-0 left-0 h-screen w-48 md:w-1/4 transform ${
      ...
      {/* Main content */}
      <div className="flex-1  h-screen overflow-y-auto bg-gray-850 text-gray-200 p-4">
        {/* Toggle button for mobile */}
        <button
          className="md:hidden text-black p-2 rounded mb-4 focus:outline-none"
          onClick={toggleSidebar}
        >
          <CgMenuLeft size={24} />
        </button>
